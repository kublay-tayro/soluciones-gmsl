                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {filteredProducts.map(product => (
                                        <tr key={product.id} className="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className="py-4 px-6">
                                                <div>
                                                    <p className="font-semibold text-slate-900">{product.currency === 'USD' ? 'USD ' : 'S/ '}{product.price?.toLocaleString()}</p>
                                                    {product.original_price && (
                                                        <p className="text-slate-400 text-xs line-through">
                                                            {product.currency === 'USD' ? 'USD ' : 'S/ '}{product.original_price?.toLocaleString()}
                                                        </p>
                                                    )}
                                                </div>
                                            </td>
